...
```{r, echo=FALSE}
(qcresults <- names(seqfile@QCresult)[names(seqfile@QCresult) %in% c("MissingRate", "SexCheck", "Inbreeding", "IBD", "PCA")])
```
...
if("MissingRate" %in% qcresults){
    ...
    ## tail(res.mr)
    ## table(res.mr$outlier)
    plotMissingRate(seqfile, interactive = interactive)    
}else{
...
if("SexCheck" %in% qcresults){
    ...
    plotSexCheck(seqfile, interactive = interactive)
}else{
...
if("Inbreeding" %in% qcresults){
    ...
    plotInbreeding(seqfile, interactive = interactive)
}else{
...
if("IBD" %in% qcresults){
    ...
    plotIBD(seqfile, interactive = interactive)
}else{
...
if("PCA" %in% qcresults){
    ...
    plotPop(seqfile, interactive = interactive)
}else{
...
```{r, echo=FALSE}
if ("problem.list" %in% names(seqfile@QCresult)){
    (probs <- seqfile@QCresult$problem.list)
}else{
